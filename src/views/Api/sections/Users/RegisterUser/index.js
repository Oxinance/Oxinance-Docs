...
const RegisterUser = forwardRef((props, ref) => {
        ...
        if (selectedLanguage === "Node JS") {
            return (
                <>
                    ...
                    <p style={{color: "#F5FBFF", fontFamily: "JetBrainsMono-Medium", fontSize: 13}}><span style={{color: "#697386"}}>5</span> <Token>const</Token> response = <Token>await</Token> oxinance<Comment>.</Comment>Users<Comment>.</Comment>register(&#123;username: <String>&quot;Jane Doe&quot;</String>, email: <String>&quot;jane@example.com&quot;</String>, password1: <String>&quot;JanePassword&quot;</String>, password2: <String>&quot;JanePassword&quot;</String>&#125;)<Comment>;</Comment></p>
    ...
    return (
        <Grid id={"api-users-register"} ref={ref} style={{backgroundColor: "white", paddingTop: 80, paddingBottom: 80}} container px={props.spacing} columnSpacing={10}>
            <Grid item xs={12} lg={6}>
                ...
                <Divider/>
                <p><SyntaxText>email</SyntaxText> <span style={{color: "#3C4257", fontWeight: "bold", fontFamily: "JetBrainsMono-Medium", fontSize: 13}}>string</span> <span style={{fontSize: 10, color: "#E56F4A"}}>REQUIRED</span></p>
                <Divider/>
                <p><SyntaxText>password1</SyntaxText> <span style={{color: "#3C4257", fontWeight: "bold", fontFamily: "JetBrainsMono-Medium", fontSize: 13}}>string</span> <span style={{fontSize: 10, color: "#E56F4A"}}>REQUIRED</span></p>
                <p style={{fontSize: 14, color: "#4F566B"}}>Must be equal to <SyntaxText>password2</SyntaxText></p>
                <Divider/>
                <p><SyntaxText>password2</SyntaxText> <span style={{color: "#3C4257", fontWeight: "bold", fontFamily: "JetBrainsMono-Medium", fontSize: 13}}>string</span> <span style={{fontSize: 10, color: "#E56F4A"}}>REQUIRED</span></p>
                <p style={{fontSize: 14, color: "#4F566B"}}>Must be equal to <SyntaxText>password1</SyntaxText></p>
                <Divider/>
                <p><SyntaxText>first_name</SyntaxText> <span style={{color: "#3C4257", fontWeight: "bold", fontFamily: "JetBrainsMono-Medium", fontSize: 13}}>string</span> <span style={{fontSize: 10, color: "#A3ACB9"}}>optional</span></p>
                <Divider/>
                <p><SyntaxText>last_name</SyntaxText> <span style={{color: "#3C4257", fontWeight: "bold", fontFamily: "JetBrainsMono-Medium", fontSize: 13}}>string</span> <span style={{fontSize: 10, color: "#A3ACB9"}}>optional</span></p>
                <Divider/>
