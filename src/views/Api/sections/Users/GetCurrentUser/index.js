...
const GetCurrentUser = forwardRef((props, ref) => {
    ...
    const renderGlobalPublicKeyContent = () => {
        ...
        if (selectedLanguage === "Node JS") {
            ...
            return (
                <p style={{color: "#F5FBFF", fontFamily: "Menlo, Consolas, monospace", fontSize: 13}}><span style={{color: "#C1C9D2"}}>$</span> curl <Comment>api.oxinance.com/v1/users/current</Comment> -XGET \ <br/> &nbsp;&nbsp;-H <String>&quot;project-public-key: <String>{examplePublicKey}</String>&quot;</String> \ <br/> &nbsp;&nbsp;-H <String>&quot;project-authorization: <String>{exampleAuthToken}</String>&quot;</String></p>
            )
        }
    }
    ...
    return (
        <Grid ref={ref} style={{backgroundColor: "white", paddingTop: 80, paddingBottom: 80}} container px={props.spacing} columnSpacing={10}>
            ...
            <Grid item xs={12} lg={6}>
                ...
                <Code title={<p style={{color: "#A3ACB9", fontSize: 10, fontFamily: "Menlo, Consolas, monospace"}}><Token>GET</Token> /v1/users/current</p>} selectedLanguage={selectedLanguage} showMenu={true} menuItems={[
                    {
