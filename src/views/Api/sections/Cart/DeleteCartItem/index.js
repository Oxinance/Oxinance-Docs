        ...
        if (selectedLanguage === "Node JS") {
            return (
                <>
                    ...
                    <p style={{color: "#F5FBFF", fontFamily: "JetBrainsMono-Medium", fontSize: 13}}><span style={{color: "#697386"}}>6</span> <Token>const</Token> response = <Token>await</Token> oxinance<Comment>.</Comment>CartItems<Comment>.</Comment>delete(<String>&quot;citem_ag3g6fa632af4s35f6fa159g26sdaav5&quot;</String>)<Comment>;</Comment></p>
