...
const productId = "prod_MsgdQ7sIvoLL2H"

const GetProduct = forwardRef((props, ref) => {
        ...
        if (selectedLanguage === "Node JS") {
            return (
                <>
                    ...
                    <p style={{color: "#F5FBFF", fontFamily: "Menlo, Consolas, monospace", fontSize: 13}}><span style={{color: "#697386"}}>5</span> <Token>const</Token> user = oxinance.getProduct(<String>&quot;{productId}&quot;</String>);</p>
            ...
            return (
                <>
                    ...
                    <p style={{color: "#F5FBFF", fontFamily: "Menlo, Consolas, monospace", fontSize: 13}}><span style={{color: "#697386"}}>6</span> <Token>const</Token> products = <Token>await</Token> axios.get(<String>&quot;https://api.oxinance.com/v1/products/prod_MsgdQ7sIvoLL2H&quot;</String>);</p>
                </>
            )
        } else if (selectedLanguage === "cURL") {
            return (
                <p style={{color: "#F5FBFF", fontFamily: "Menlo, Consolas, monospace", fontSize: 13}}><span style={{color: "#C1C9D2"}}>$</span> curl <Comment>api.oxinance.com/v1/products/prod_MsgdQ7sIvoLL2H</Comment> -XGET \ <br/> &nbsp;&nbsp;-H <String>&quot;project-public-key: <String>{examplePublicKey}</String>&quot;</String></p>
            )
        }
    }
    ...
    return (
        <Grid ref={ref} style={{backgroundColor: "white", paddingTop: 80, paddingBottom: 80}} container px={props.spacing} columnSpacing={10}>
            <Grid item xs={12} lg={6}>
                ...
                <p style={{fontSize: 14, color: "#4F566B"}}>Retrieves the details of an existing product. Supply the unique product ID Oxinance will return the corresponding product information.</p>
                <br/>
                ...
                <Divider/>
                <p style={{fontSize: 14, color: "#4F566B"}}>Returns a product object if a valid identifier was provided.</p>
            </Grid>
            <Grid item xs={12} lg={6}>
